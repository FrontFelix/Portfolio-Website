...
export default function Contact() {
  ...
  const sendMessageToWebhook = (e) => {
    ...
    const webhookUrl = 'https://discordapp.com/api/webhooks/1087687219898236938/B6EGpurW_27Q58PoaHO5gKYu1M_rcE0CNLuzjjzcfYJMkI65tlPjLY0aZwEM1vDD8wk-';
...
fetch(webhookUrl, {
  ...
  return (
    <div id="contact" className="container-small-width w-full text-left flex justify-between gap-8 lg:gap:0 items-center text-white flex-col lg:flex-row p-8 lg:p-8 xl:p-0">
      <div className="w-full lg:w-2/5 flex gap-5 flex-col">
        ...
        <div className="flex gap-2">
          <a href="https://www.linkedin.com/in/felix-bakkum-252b26192/" target="_blank">
            <AiFillLinkedin size={"2rem"} />
          </a>
          <a href="https://github.com/FrontFelix" target="_blank">
            <AiFillGithub size={"2rem"} />
          </a>
        </div>
      </div>
      <div className="w-full lg:w-1/2">
        <form onSubmit={(e) => { sendMessageToWebhook(e) }} className="flex flex-wrap gap-8 justify-start lg:justify-end">
